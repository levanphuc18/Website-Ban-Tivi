		...
		<div class="main__new-product section px-32 my-6">
			<div class="section__heading mb-8">
				<div class="product-navigation font-bold mb-5">
					<h3 class="text-indigo-500 font-bold text-xl">Thể loại:
						${pagedListHolder.pageList[0].category.name}</h3>

				</div>
				<hr class="border-none bg-indigo-500" style="height: 1px;">
				<c:if test="${pagedListHolder.pageList.size()==0}">
					<p class="mt-5">Chưa có sản phẩm thuộc thể loại này.</p>
					<p class="mb-2">
						...
						<div>
							<div class="relative item-menu-container overflow-hidden">
								...
								<div
									...
									<a
										href="store/insert-to-favlist/${pd.id}/categoryseperator${pd.category.id}seperatorquestionmarkp=${pagedListHolder.page}">
									...
									<a
										href="store/shopping-cart/insert-into-cart/${pd.id}/categoryseperator${pd.category.id}seperatorquestionmarkp=${pagedListHolder.page}"><i
