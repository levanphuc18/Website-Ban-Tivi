...
<body>
	...
	<main class="main">
		<div
			...
			<div class="pt-3 text-xl text-center text-indigo-400">THÔNG
				TIN CỦA TÀI KHOẢN CẦN KHÔI PHỤC MẬT KHẨU</div>
			<f:form action="${applicationScope.forgotPassPage}"
				class="w-full  p-4" method="post" modelAttribute="account">
				...
				<button id="submit-button"
					class="w-full px-4 py-2 font-bold bg-indigo-400 hover:bg-indigo-500 transition-colors text-white rounded-md mb-3">LẤY
					MÃ KHÔI PHỤC</button>
			</f:form>
