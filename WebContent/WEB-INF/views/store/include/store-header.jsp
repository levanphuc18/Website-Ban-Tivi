...
<body>
	...
	<c:if test="${message!=null}">
		<div class="msg rounded-md overflow-hidden">
			<div
				class="msg-detail flex justify-between items-center bg-gray-500 h-full ">
				<span class="p-2">${message}</span>
				<div
					class="cursor-pointer p-2 hover:bg-gray-400 self-stretch transition-all flex items-center">
	...
	<header class="header">
		<ul class="nav__top flex justify-end bg-gray-300">
			<li><a href="#store-address"
				class="px-4 py-1 block font-bold hover:text-indigo-500 transition-colors">Liên
					Hệ</a></li>
			<li><a href="#"
		...
		<div class="nav__middle flex justify-between px-32 items-center">
			<div class="nav__middle-left flex justify-between items-center">
				<div class="mobile-menu-button test-ani cursor-pointer hidden">
					<div class="bar-top bg-gray-300"></div>
					<div class="bar-middle bg-gray-300"></div>
					<div class="bar-bottom bg-gray-300"></div>
				</div>
				<a href="${applicationScope.storeIndexPage}"
					...
					src="<c:url value='/resources/store/assets/img/logo_header.png' />">
				</a>
			...
			<div
				...
				<div class="nav__middle-bottom flex-1 mt-8">
					<form action="store/search" method="get"
						...
						<!-- <button><i
                                class="fa fa-search p-2 bg-gray-400 hover:bg-gray-500 text-white rounded-r-md hover:text-white"></i></button> -->
						<a href="" id="search-link"><i
							class="fa fa-search p-2 bg-gray-400 hover:bg-gray-500 text-white rounded-r-md hover:text-white"></i></a>
					</form>
		...
		<div class="nav__bottom flex items-center px-32 bg-gray-300 uppercase">
