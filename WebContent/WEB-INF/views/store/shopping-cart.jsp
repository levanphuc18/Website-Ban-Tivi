...
<body>
	...
	<main class="main">
		<div class="cart-list__container main__new-product px-32 my-6">
			<h3 class="text-indigo-500 font-bold mb-4 text-xl">GIỎ HÀNG
				CỦA BẠN</h3>
			...
			<form action="store/shopping-cart/update" method="post">
						...
						<c:forEach var="c" items="${listCartDetail}">
							<tr class="card-list__table-item">
								...
								<td class="card-list__table-desc" style="text-align: left;"><a
									...
									<div>Tồn kho: ${c.product.quantity}</div></td>
								<td class="cart-list__price font-bold"><fmt:setLocale
								...
								<td class="cart-list__quantity">
									<div class="input-group flex align-items-center">
										...
										<input type="number" step="1" max="${c.product.quantity}"
											min="1" value="${c.quantity}" name="quantity"
				...
				<div class="flex justify-end mb-4">
					...
					<a href="store/shopping-cart/check-out"
						class="ml-2 px-4 py-2 font-bold bg-indigo-400 hover:bg-indigo-500 transition-colors text-white rounded-md">Thanh
						toán</a>
				</div>
			</form>
							...
							<div>
								<div class="relative item-menu-container overflow-hidden">
									...
									<div
										...
										<a href="store/insert-to-favlist/${p.id}/user-cart"> <c:set
	...
	<script
		src="<c:url value='/resources/store/assets/js/cart.js?version=51'/>"></script>
</body>
</html>