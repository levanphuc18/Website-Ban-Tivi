		...
		<div class="main__new-product section px-32 my-6">
			<div class="section__heading mb-8">
				<div class="product-navigation font-bold mb-5">
					<h3 class="text-indigo-500 font-bold text-xl ">TẤT CẢ SẢN
						PHẨM</h3>
			...
			<div class="new-product__list flex flex-wrap">
				...
				<c:url value="store/all/" var="pagedLink">
						...
						<div>
							<div class="relative item-menu-container overflow-hidden">
								...
								<div
									...
									<a
										href="store/insert-to-favlist/${pd.id}/allseperatorquestionmarkp=${pagedListHolder.page}">
									...
									<a
										href="store/shopping-cart/insert-into-cart/${pd.id}/allseperatorquestionmarkp=${pagedListHolder.page}"><i
