		...
		<div class="d-flex justify-content-between w-100"
					...
					<div class="d-flex align-items-center">
						<svg class="icon icon-xs me-2" fill="none" stroke="currentColor"
							...
							<path stroke-linecap="round" stroke-linejoin="round"
								stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
			...
			<ul class="navbar-nav align-items-center">
				<li class="nav-item dropdown"><a
					...
					aria-expanded="false"> <svg class="icon icon-sm text-gray-900"
							fill="currentColor" viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg">
							<path
								d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"></path></svg>
				</a>
					<div
						class="dropdown-menu dropdown-menu-lg dropdown-menu-center mt-2 py-0">
						<div class="list-group list-group-flush">
							<div
								class="h6 my-0 text-center text-danger fw-bold border-bottom border-light py-3 d-flex align-items-center justify-content-center">
								<svg class="icon icon-xs me-2" fill="none" stroke="currentColor"
									viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
									<path stroke-linecap="round" stroke-linejoin="round"
										stroke-width="2"
									...
									<path stroke-linecap="round" stroke-linejoin="round"
										stroke-width="2"
										d="M9.879 16.121A3 3 0 1012.015 11L11 14H9c0 .768.293 1.536.879 2.121z"></path></svg>
								Đơn hàng mới
							</div>

							<c:forEach items="${applicationScope.lastestOrders}" var="order"
								...
								<a href="${applicationScope.ordersPage}/${order.id}"
									...
									<div class="row align-items-center">
										<div class="col-auto d-flex flex-column">
											<small class="text-danger"> <fmt:setLocale
													value="vi_VN" scope="session" /> <fmt:formatDate
													value="${order.orderDate}" pattern="HH:mm" />
											</small> <small class="text-danger"> <fmt:setLocale
													value="vi_VN" scope="session" /> <fmt:formatDate
													value="${order.orderDate}" pattern="dd/MM" />
											</small>
											<!-- Avatar -->
										...
										<div class="col ps-0 ms-2">
											<div
												...
												<div class="text-end">
													...
													<small
														class="text-success d-flex flex-column align-items-end">
														<fmt:setLocale value="vi_VN" scope="session" /> <fmt:formatNumber
															value="${order.getTotalPrice()}" type="currency" />
													</small>
												</div>
											</div>
											<p class="font-small mt-1 mb-0 text-truncate">
												<svg class="icon icon-xxs text-gray-400" fill="none"
													stroke="currentColor" viewBox="0 0 24 24"
													xmlns="http://www.w3.org/2000/svg">
													<path stroke-linecap="round" stroke-linejoin="round"
														stroke-width="2"
											...
											<p class="font-small my-0">
												<span class="d-inline-block text-truncate"
													style="min-width: 200px;"> <svg
														class="icon icon-xxs text-gray-400" fill="none"
														stroke="currentColor" viewBox="0 0 24 24"
														xmlns="http://www.w3.org/2000/svg">
														<path stroke-linecap="round" stroke-linejoin="round"
															stroke-width="2"
							...
							<a href="${applicationScope.ordersPage}"
								class="dropdown-item text-center fw-bold rounded-bottom py-3">
								<svg class="icon icon-xxs text-gray-400 me-1"
									fill="currentColor" viewBox="0 0 20 20"
									xmlns="http://www.w3.org/2000/svg">
									<path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path>
									<path fill-rule="evenodd"
										d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z"
										clip-rule="evenodd"></path></svg> Xem tất cả
							</a>
						</div>
					</div></li>
				...
				<li class="nav-item dropdown ms-lg-3"><a
					class="nav-link dropdown-toggle pt-1 px-0" role="button"
					data-bs-toggle="dropdown" aria-expanded="false">
						<div class="media d-flex align-items-center">
							<span class="avatar rounded-circle">T</span>
							<div
								class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
								<span class="mb-0 font-small fw-bold text-gray-900">${sessionScope.admin.lastname}
									${sessionScope.admin.firstname}</span>
							</div>
						</div>
				</a>
					<div
						...
						<a class="dropdown-item d-flex align-items-center"
							href="${applicationScope.profilePage }"> <svg
								class="dropdown-icon text-gray-400 me-2" fill="currentColor"
								viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd"
									d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z"
									clip-rule="evenodd"></path></svg> Thông tin của tôi
						</a>
						<%-- <a class="dropdown-item d-flex align-items-center" href="${applicationScope.profilePage }">
            ...
            <a class="dropdown-item d-flex align-items-center" href="#">
              ...
              Hỗ trợ
						...
						<a class="dropdown-item d-flex align-items-center"
							href="${applicationScope.logoutPage }"> <svg
								class="dropdown-icon text-danger me-2" fill="none"
								stroke="currentColor" viewBox="0 0 24 24"
								xmlns="http://www.w3.org/2000/svg">
								<path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2"
