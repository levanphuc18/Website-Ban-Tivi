...
<nav
	...
	<a class="navbar-brand me-lg-5"
		href="${applicationScope.dashboardPage }"> <img
		class="navbar-brand-dark"
		src="<c:url value='/resources/admin/assets/img/brand/light.svg' />"
		alt="Volt logo" /> <img class="navbar-brand-light"
		src="<c:url value='/resources/admin/assets/img/brand/dark.svg' />"
		alt="Volt logo" />
	</a>
...
<nav id="sidebarMenu"
	...
	<div class="sidebar-inner px-4 pt-3">
		<div
			...
			<div class="d-flex align-items-center">
				<div class="avatar-lg me-4">
					<img
						src="<c:url value='/resources/admin/assets/img/team/profile-picture-3.jpg' />"
		...
		<ul class="nav flex-column pt-3 pt-md-0">
			<li class="nav-item"><a
				href="${applicationScope.dashboardPage }"
				class="nav-link d-flex align-items-center"> <span
					class="sidebar-icon text-warning"> <svg
							xmlns="http://www.w3.org/2000/svg" width="16" height="16"
							fill="currentColor" class="bi bi-asterisk" viewBox="0 0 16 16">
                            <path
								d="M8 0a1 1 0 0 1 1 1v5.268l4.562-2.634a1 1 0 1 1 1 1.732L10 8l4.562 2.634a1 1 0 1 1-1 1.732L9 9.732V15a1 1 0 1 1-2 0V9.732l-4.562 2.634a1 1 0 1 1-1-1.732L6 8 1.438 5.366a1 1 0 0 1 1-1.732L7 6.268V1a1 1 0 0 1 1-1z" />
                        </svg>
				</span> <span class="mt-1 ms-1 sidebar-text fst-italic  fw-bolder">LightStudio</span>
			</a></li>
			<li class="nav-item active"><a
				href="${applicationScope.dashboardPage }" class="nav-link"> <span
					class="sidebar-icon"> <!-- <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path>
                            <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path>
                        </svg> --> <svg class="icon icon-xs me-2"
							...
							<path stroke-linecap="round" stroke-linejoin="round"
								stroke-width="2"
								d="M20.488 9H15V3.512A9.025 9.025 0 0120.488 9z"></path></svg>
				</span> <span class="sidebar-text">Dashboard</span>
			</a></li>
        ...
        <div class="multi-level collapse "
          ...
          <ul class="flex-column nav">
			...
			<li class="nav-item"><span
				...
				data-bs-toggle="collapse" data-bs-target="#subcategory-pages">
					<span> <span class="sidebar-icon"> <svg
								...
								<path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2"
									d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path></svg>
					</span> <span class="sidebar-text">Danh mục</span>
				...
				<div class="multi-level collapse" role="list" id="subcategory-pages"
					aria-expanded="false">
					<ul class="flex-column nav">
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.categoryPage}"> <span
								class="sidebar-text">Quản Lý</span>
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.addCategoryPage}"> <span
								class="sidebar-text">Thêm danh mục</span>
						</a></li>
					</ul>
				</div></li>
			...
			<li class="nav-item"><span
				class="nav-link collapsed d-flex justify-content-between align-items-center"
				data-bs-toggle="collapse" data-bs-target="#subproduct-pages">
					<span> <span class="sidebar-icon"> <svg
								class="icon icon-xs me-2" fill="none" stroke="currentColor"
								viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								<path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
					</span> <span class="sidebar-text">Sản phẩm</span>
				</span> <span class="link-arrow"> <svg class="icon icon-sm"
							fill="currentColor" viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
				...
				<div class="multi-level collapse" role="list" id="subproduct-pages"
					aria-expanded="false">
					<ul class="flex-column nav">
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.productPage}"> <span
								class="sidebar-text">Quản Lý</span>
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.addProductPage}"> <span
								class="sidebar-text">Thêm sản phẩm</span>
						</a></li>
					</ul>
				</div></li>
			...
			<li class="nav-item"><span
				class="nav-link collapsed d-flex justify-content-between align-items-center"
				data-bs-toggle="collapse" data-bs-target="#subinvoice-pages">
					<span> <span class="sidebar-icon"> <svg
								class="icon icon-xs me-2" fill="none" stroke="currentColor"
								viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								<path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2"
									d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z"></path></svg>
					</span> <span class="sidebar-text">Hoá đơn</span>
				</span> <span class="link-arrow"> <svg class="icon icon-sm"
							fill="currentColor" viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
				...
				<div class="multi-level collapse" role="list" id="subinvoice-pages"
					aria-expanded="false">
					<ul class="flex-column nav">
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.invoicePage}"> <span
								class="sidebar-text">Quản lý</span>
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.addInvoicePage}"> <span
								class="sidebar-text">Tạo hoá đơn</span>
						</a></li>
						<%--
                        <li class="nav-item">
			...
			<li class="nav-item"><span
				class="nav-link collapsed d-flex justify-content-between align-items-center"
				data-bs-toggle="collapse" data-bs-target="#suborder-pages"> <span>
					...
					</span> <span class="sidebar-text">Đơn hàng</span>
				</span> <span class="link-arrow"> <svg class="icon icon-sm"
							fill="currentColor" viewBox="0 0 20 20"
							xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
				...
				<div class="multi-level collapse" role="list" id="suborder-pages"
					aria-expanded="false">
					<ul class="flex-column nav">
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.ordersPage}"> <span
								class="sidebar-text">Quản lý</span>
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="${applicationScope.ordersPage}"> <span
								class="sidebar-text">Chỉnh sửa</span>
						</a></li>
					</ul>
				</div></li>

			<!-- Customer Manager -->
			<li class="nav-item"><a href="${applicationScope.customerPage }"
				class="nav-link"> <span class="sidebar-icon"> <!-- <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
                            <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"></path>
                        </svg> --> <span class="sidebar-icon"> <svg
								class="icon icon-xs" fill="none" stroke="currentColor"
								viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
								<path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2"
									d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
					</span>
				</span> <span class="sidebar-text">Khách hàng</span>
			</a></li>
      ...
      <li class="nav-item">
       ...
       -->
			<li role="separator"
				class="dropdown-divider mt-4 mb-3 border-gray-700"></li>

			<!-- Mail -->
			<li class="nav-item"><a href="${applicationScope.mailPage }"
				class="nav-link"> <span class="sidebar-icon"> <!-- <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
                            <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"></path>
                        </svg> --> <svg class="icon icon-xs me-2"
				...
				</span> <span class="sidebar-text">Mail</span>
			</a></li>

			<!-- SETTINGS -->
			<li class="nav-item"><a href="${applicationScope.profilePage}"
				class="nav-link"> <span class="sidebar-icon"> <!-- <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path
                                fill-rule="evenodd"
							...
							<path stroke-linecap="round" stroke-linejoin="round"
								stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
				</span> <span class="sidebar-text">Thông tin</span>
			</a></li>
