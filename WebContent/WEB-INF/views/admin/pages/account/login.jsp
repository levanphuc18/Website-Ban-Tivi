...
<body>
	<main>
		...
		<section
			...
			<div class="container">
				<%-- <p class="text-center">
	                  <a href="${applicationScope.dashboardPage }" class="d-flex align-items-center justify-content-center">
				...
				<div class="row justify-content-center form-bg-image"
					data-background-lg="<c:url value='/resources/admin/assets/img/illustrations/signin.svg' />">
					<div
						...
						<div
							...
							<form:form action="admin/login" class="mt-4" method="post"
								...
								<div class="form-group mb-4">
									...
									<div class="input-group">
										<span class="input-group-text" id="basic-addon1"> <svg
												class="icon icon-xs text-gray-600" fill="none"
												stroke="currentColor" viewBox="0 0 24 24"
												xmlns="http://www.w3.org/2000/svg">
												<path stroke-linecap="round" stroke-linejoin="round"
													stroke-width="2"
													d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
										</span>
										<form:input type="text" placeholder="Nhập tên đăng nhập..."
											class="form-control ${usernameValid }" id="username"
								...
								<div class="form-group">
									...
									<div class="form-group mb-4">
										...
										<div class="input-group">
											<span class="input-group-text" id="basic-addon2"> <svg
													...
													<path stroke-linecap="round" stroke-linejoin="round"
														stroke-width="2"
														d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z"></path></svg>
											</span>
											<form:input type="password" placeholder="Nhập mật khẩu..."
												class="form-control ${passwordValid }" id="password"
												path="password" autofocus="autofocus" />
									...
									<div class="d-flex justify-content-end align-items-top mb-4">
										...
										<div>
											<a href="${applicationScope.forgotPasswordPage }"
												class="small text-right">Quên mật khẩu?</a>
										</div>
									</div>
								</div>
								<div class="d-grid">
									<button type="submit" class="btn btn-gray-800">Đăng
										nhập</button>
								</div>
							</form:form>
							<%-- <div class="mt-3 mb-4 text-center">
	                          ...
	                          <div class="d-flex justify-content-center align-items-center mt-4">
	                              <span class="fw-normal">
	                                  Not registered?
	                                  <a href="${applicationScope.registerPage }" class="fw-bold">Create account</a>
	                              </span>
	                          </div> --%>
						</div>
					</div>
