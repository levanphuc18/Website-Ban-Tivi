...
<body>
	...
	<main class="content">
		...
		<form:form action="${applicationScope.registerPage }" method="post"
			modelAttribute="newAdmin" enctype="multipart/form-data">
			<div class="row">
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								<div>
									...
									<form:input path="account.username"
										class="form-control ${usernameValid }" id="lastname"
							...
							<div class="col-md-6 mb-3">
								<div>
									...
									<form:input class="form-control ${passwordValid }"
										path="account.password" id="firstname" type="text"
							...
							<div class="col-md-6 mb-3">
								<div>
									<label for="firstname">Nhập lại mật khẩu</label> <input
										class="form-control ${rePasswordValid }" name="rePassword"
										id="firstname" type="text" placeholder="Nhập lại mật khẩu" />
						...
						<div class="col-12 mb-4">
							<div class="card shadow border-0 text-center p-0">
								<div class="rounded-top profile-cover overflow-hidden">
									<img src="${newAdmin.cover}" class="image-fluid"
										alt="${admin.firstname}" id="preview-cover" />
								</div>
								<div class="card-body">
									<img src="${newAdmin.image}" id="preview-image"
						...
						<div class="col-12">
                          ...
                          <path fill-rule="evenodd"
												...
												<div class="d-md-block text-left">
													...
													<div class="text-gray small">JPG, GIF hoặc PNG. Tối
														đa 2MB</div>
												</div>
											</div>
										</div>
