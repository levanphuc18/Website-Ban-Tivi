				...
				<div class="row justify-content-center form-bg-image">
					...
					<div
						...
						<div
							...
							<p class="mb-4">Đừng lo lắng! Hãy điền đầy đủ thông tin dưới
								đây và chúng tôi sẽ gửi mã không phục mật khẩu cho bạn.</p>
							<form:form action="${applicationScope.forgotPasswordPage }"
								...
								<div class="mb-4">
									...
									<div class="input-group">
										<form:input path="id" type="id"
											class="form-control ${idValid }" id="id"
											placeholder="Nhập mã admin..." autofocus="autofocus" />
								...
								<div class="mb-4">
									...
									<div class="input-group">
										<form:input path="account.username" type="text"
											...
											placeholder="Nhập tên đăng nhập..." autofocus="autofocus" />
								...
								<div class="mb-4">
									...
									<div class="input-group">
										<form:input path="email" type="email"
											class="form-control ${emailValid }" id="email"
											placeholder="john@company.com" autofocus="autofocus" />
										<form:errors path="email" class="invalid-feedback" />
									</div>
								</div>
								<!-- End of Form -->
								<div class="d-grid">
									<button type="submit" class="btn btn-gray-800">Lấy mã
										khôi phục</button>
								</div>
							</form:form>
						</div>
