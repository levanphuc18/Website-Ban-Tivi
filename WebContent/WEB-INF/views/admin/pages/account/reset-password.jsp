		...
		<section
			...
			<div class="container">
				<div class="row justify-content-center form-bg-image">
					<p class="text-center">
						<a href="${applicationScope.loginPage}"
							class="d-flex align-items-center justify-content-center"> <svg
								...
								<path fill-rule="evenodd"
									...
									clip-rule="evenodd"></path></svg> Quay lại trang đăng nhập
						</a>
					</p>
					<div
						...
						<div
							...
							<form:form
								...
								method="post" modelAttribute="reset-password">
								<!-- Form -->
								<div class="mb-4">
									...
									<div class="input-group">
										<span class="input-group-text" id="basic-addon2"> <svg
												...
												<path stroke-linecap="round" stroke-linejoin="round"
													stroke-width="2"
													d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"></path></svg>
										</span>
										<form:input type="text" path="recoveryCode"
											class="form-control ${recoveryCodeValid }"
											placeholder="Nhập mã khôi phục" id="recovery-code" />
								...
								<div class="form-group mb-4">
									...
									<div class="input-group">
										<span class="input-group-text" id="basic-addon2"> <svg
												...
												<path stroke-linecap="round" stroke-linejoin="round"
													stroke-width="2"
													d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
										</span>
										<form:input path="newPassword" type="password"
											placeholder="Nhập mật khẩu mới"
											class="form-control ${newPasswordValid }" id="password" />
								...
								<div class="form-group mb-4">
									...
									<div class="input-group">
										...
										<form:input type="password" path="rePassword"
											...
											class="form-control ${rePasswordValid }"
											id="confirm_password" />
								...
								<!-- End of Form -->
								<div class="d-grid">
									<button type="submit" class="btn btn-gray-800">Phục
										hồi mật khẩu</button>
								</div>
							</form:form>
						</div>
