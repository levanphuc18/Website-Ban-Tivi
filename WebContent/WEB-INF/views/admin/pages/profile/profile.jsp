	...
	<main class="content">
		...
		<div
			...
			<div>
				<div class="dropdown">
					<button
						class="btn btn-secondary d-inline-flex align-items-center me-3 dropdown-toggle"
					...
					<div
						...
						<a class="dropdown-item d-flex align-items-center"
							href="${applicationScope.addCategoryPage }"> <svg
								class="dropdown-icon text-gray-400 me-2" fill="none"
							...
							href="${applicationScope.addProductPage }"> <svg
								class="dropdown-icon text-gray-400 me-2" fill="none"
								stroke="currentColor" viewBox="0 0 24 24"
								xmlns="http://www.w3.org/2000/svg">
					        <path stroke-linecap="round" stroke-linejoin="round"
									stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
					      </svg> Sản phẩm
						</a> <a class="dropdown-item d-flex align-items-center"
							href="${applicationScope.addInvoicePage }"> <svg
								class="dropdown-icon text-gray-400 me-2" fill="none"
								stroke="currentColor" viewBox="0 0 24 24"
								xmlns="http://www.w3.org/2000/svg">
					        <path stroke-linecap="round" stroke-linejoin="round"
						...
						<a class="dropdown-item d-flex align-items-center"
							href="${applicationScope.registerPage }"> <svg
		...
		<div class="row">
			<div class="col-12 col-xl-8">
				<div class="card card-body border-0 shadow mb-4">
					...
					<form:form action="${applicationScope.profilePage }" method="post"
						modelAttribute="modifiedAdmin" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-6 mb-3">
								<div>
									<label for="lastname">Họ</label>
									<form:input path="lastname"
										class="form-control ${lastnameValid }" id="lastname"
							...
							<div class="col-md-6 mb-3">
								<div>
									...
									<form:input class="form-control ${firstnameValid }"
						...
						<div class="row align-items-center">
							<div class="col-md-6 mb-3">
								...
								<div class="input-group">
									...
									<form:input type="text" class="form-control ${birthdayValid }"
										path="birthday" id="birthday"
										placeholder="Nhập ngày tháng năm sinh" data-input="data-input" />
									<form:errors path="birthday" class="invalid-feedback" />
								</div>
							</div>
							<div class="col-md-6 mb-3">
								<label for="gender">Giới tính</label>
								<form:select class="form-select mb-0 ${genderValid }"
									id="gender" path="gender" aria-label="Gender select example">
									<form:option value="">...</form:option>
									<form:option value="0"
										selected="${admin.gender.equals('0') ? 'selected' : '' }">Nam</form:option>
									<form:option value="1"
										selected="${admin.gender.equals('1') ? 'selected' : '' }">Nữ</form:option>
								</form:select>
						...
						<div class="row">
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<form:input class="form-control ${emailValid }" path="email"
							...
							<div class="col-md-6 mb-3">
								<div class="form-group">
									...
									<form:input class="form-control ${phoneValid }" path="phone"
										id="phone" type="text" placeholder="Nhập số điện thoại" />
							...
							<div class="col-sm-12 mb-3">
								<div class="form-group">
									...
									<form:input class="form-control" path="address" id="address"
										type="text" placeholder="Nhập địa chỉ nhà" />
								</div>
							</div>
						...
						<!-- <div class="row">
                             ...
                             -->
						<div class="mt-3">
							<button class="btn btn-gray-800 mt-2 animate-up-2" type="submit">Lưu
								thông tin</button>
						</div>
				</div>
				<div class="row">
									...
									<div class="d-flex justify-content-xl-center ms-xl-3">
										<div class="d-flex">
											...
											<div class="d-md-block text-left">
												...
												<div class="text-gray small">JPG, GIF hoặc PNG. Tối đa
													2MB</div>
											</div>
										</div>
									</div>
					...
					<div class="col-12 mb-4">
						<div class="card shadow border-0 text-center p-0">
							...
							<div class="rounded-top profile-cover overflow-hidden">
								<img src="${admin.cover}" class="image-fluid"
									alt="${admin.firstname}" id="preview-cover">
							</div>
							<div class="card-body">
								<img src="${admin.image}" id="preview-image"
