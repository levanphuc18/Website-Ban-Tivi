				...
				<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
					<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page"><a
							href="${applicationScope.customerPage }">${title}</a></li>
					</ol>
				</nav>
					...
					<form action="${requestScope['javax.servlet.forward.request_uri']}"
						...
						<div class="input-group me-2 me-lg-3 fmxw-300">
							<input type="text" class="form-control" placeholder="Tìm kiếm"
								...
								href="${applicationScope.customerPage}"> <svg
				...
				<tbody>
					<c:forEach items="${pagedListHolder.pageList}" var="customer">
						<tr>
							...
							<td>
								...
								<div class="d-block">
									<span class="fw-bold"><a
										href="${applicationScope.customerPage }/${customer.id}">${customer.id}</a></span>
									<!-- <div class="small text-gray">
                                            <span class="__cf_email__" data-cfemail="fd94939b92bd98859c908d9198d39e9290">[email&#160;protected]</span>
                                        </div> -->
								</div> </a>
							</td>
							<td><span class="fw-normal">${customer.firstname}
									${customer.lastname}</span></td>
							<td><span
								class="fw-normal d-flex align-items-center text-wrap"> <svg
							...
							<td><span class="fw-normal text-wrap">${customer.address}</span>
							</td>
							<%--  <td>
                           <span class="fw-normal text-wrap">
							...
							<td><span class="fw-normal">${customer.email}</span></td>
							<td><span class="fw-normal"> <fmt:setLocale
										value="vi_VN" scope="session" /> <fmt:parseDate
										value="${customer.dateAdded }" type="date"
								...
								<div class="btn-group">
									...
									<div
										...
										<form action="${applicationScope.mailPage }" method="post">
											...
											<button class="dropdown-item d-flex align-items-center"
												...
												<svg xmlns="http://www.w3.org/2000/svg" width="16"
													...
													class="bi bi-envelope dropdown-icon text-info me-2"
													viewBox="0 0 16 16">
											  <path fill-rule="evenodd"
										...
										<a class="dropdown-item d-flex align-items-center"
											href="${applicationScope.customerPage }/${customer.id}">
