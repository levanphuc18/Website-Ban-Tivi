								...
								<form:form
									...
									<div class="row mb-4">
										<div class="col-12">
											...
											<form:input type="text" class="form-control ${idValid }"
												path="id" id="id" placeholder="Nhập mã hóa đơn" />
									...
									<div class="row mb-4">
										<div class="col-12">
											...
											<form:select path="invoiceType.id"
												class="form-select ${invoiceTypeValid }" id="invoice-type">
									...
									<div class="row mb-4">
										<div class="col-6">
											...
											<form:input type="text" class="form-control ${dateValid }"
												path="date" id="date" placeholder="Nhập ngày lập hoá đơn"
												data-input="data-input" />
											<form:errors path="date" class="invalid-feedback" />
										</div>
										<div class="col-6">
											<label for="quantity">Thời gian lập</label>
											<form:input type="text" class="form-control ${timeValid }"
												path="time" id="time" placeholder="Nhập giờ lập hoá đơn"
												data-input="data-input" />
