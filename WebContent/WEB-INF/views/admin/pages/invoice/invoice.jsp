	...
	<main class="content">
		...
		<div
				...
				<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
					<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page"><a
							href="${requestScope['javax.servlet.forward.request_uri']}">Quản
								lý</a></li>
					</ol>
				</nav>
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				<a href="${applicationScope.addCategoryPage }"
					class="btn btn-sm btn-secondary d-inline-flex align-items-center">
					<svg class="icon icon-xs me-2" fill="none" stroke="currentColor"
						viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						<path stroke-linecap="round" stroke-linejoin="round"
							stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> Thêm hoá
					đơn
				</a>
					...
					<form action="${requestScope['javax.servlet.forward.request_uri']}"
						...
						<div class="input-group me-2 me-lg-3 fmxw-300">
							<input type="text" class="form-control" placeholder="Tìm kiếm"
								...
								href="${applicationScope.invoicePage}"> <svg
		...
		<div
			...
			<table class="table table-hover">
				...
				<tbody>
					<!-- Item -->
					<c:forEach items="${pagedListHolder.pageList}" var="invoice"
						varStatus="i">
						<tr>
							<td><a href="${applicationScope.invoicePage}/${invoice.id}"
								class="fw-bold"> ${invoice.id} </a></td>
							...
							<td><span class="fw-normal text-wrap"> <fmt:setLocale
										value="vi_VN" scope="session" /> <fmt:parseDate
										value="${invoice.date}" type="date" pattern="yyyy-MM-dd"
										var="parsedDate" /> <fmt:formatDate value="${parsedDate}"
										pattern="dd/MM/yyyy" />
							</span></td>
							<td><span class="fw-normal text-wrap"> <fmt:setLocale
										value="vi_VN" scope="session" /> <fmt:parseDate
										value="${invoice.time}" type="date" pattern="HH:mm:ss"
										var="parsedTime" /> <fmt:formatDate value="${parsedTime}"
										pattern="HH:mm:ss" />
							</span></td>
							...
							<td><span class="fw-normal"> <fmt:setLocale
										value="vi_VN" scope="session" /> <fmt:formatNumber
										value="${invoice.getTotalPrice() }" type="currency" />
							</span></td>
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu py-0">
										...
										<a class="dropdown-item rounded-top"
											...
											class="bi bi-trash2-fill dropdown-icon me-2"></i> Xoá
										</a>
									</div>
								</div>
							</td>
		...
		<div class="modal fade" id="modal-warning" tabindex="-1" role="dialog"
			aria-labelledby="modal-warning" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						...
						<small class="my-0 mt-4 text-wrap text-gray-500">Hãy chắc
							chắn danh mục này <span class="fw-bold">không tồn tại</span> sản
							phẩm nào
						</small>
					</div>
					<div class="modal-footer">
						<a type="button" class="btn btn-danger" id="btnConfirm" href="">Đồng
							ý</a>
