				...
				<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
					<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page"><a
							href="${requestScope['javax.servlet.forward.request_uri']}">Hoá
								đơn ${invoice.id}</a></li>
					</ol>
				</nav>
			  ...
			  <path
                ...
                <li class="list-group-item fw-normal">Quận 1, TPHCM</li> -->
								<li class="list-group-item fw-normal"><a
									class="fw-bold text-primary" href="#"> <span
										class="__cf_email__"
										data-cfemail="97f4f8fae7f6f9eed7e3fff2faf2e4f5f2e5f0b9f4f8fa">n20dccn128@student.ptithmc.edu.vn</span></a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="col-sm col-lg-4">
							<dl class="row text-sm-right">
								...
								<dd class="col-6">
									...
									<fmt:parseDate value="${invoice.date}" type="date"
								...
								<dd class="col-6">
									<fmt:setLocale value="vi_VN" scope="session" />
									<fmt:parseDate value="${invoice.time}" type="date"
										pattern="HH:mm:ss" var="parsedTime" />
					...
					<div class="row">
						<div class="col-12">
							<div class="table-responsive" style=''>
								<table class="table mb-0 table-sm">
									...
									<tbody>
										<c:forEach items="${invoice.invoiceDetails}"
											var="invoiceDetail" varStatus="i">
											<tr>
												<td>${i.count }</td>
												<td scope="row" class="text-left fw-bold">
													${invoiceDetail.product.id }</td>
												...
												<td><fmt:setLocale value="vi_VN" scope="session" /> <fmt:formatNumber
														value="${invoiceDetail.price }" type="currency" /></td>
												<!-- <td>1</td> -->
												<td><fmt:setLocale value="vi_VN" scope="session" /> <fmt:formatNumber
														value="${invoiceDetail.price * invoiceDetail.quantity }"
														type="currency" /></td>
												<!-- <td></td> -->
											</tr>
										</c:forEach>
                        ...
                        <td class="right">$679,76</td>
											...
											<tr>
												...
												<td class="right"><strong> <fmt:setLocale
