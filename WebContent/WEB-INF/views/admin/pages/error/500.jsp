		...
		<section
			...
			<div class="container">
				<div class="row align-items-center ">
					<div
						class="col-12 col-lg-5 order-2 order-lg-1 text-center text-lg-left">
						<h1 class="mt-5">
							Đã xảy ra sự cố <span class="text-primary fw-bolder">nghiêm
								trọng</span>!
						</h1>
						<p class="lead my-4">Hãy thư giãn một chút, đi uống cà phê
							hoặc làm gì đó. Hệ thống sẽ quay lại trong thời gian sớm thôi.</p>
						<a href="${applicationScope.dashboardPage }"
							...
							<svg class="icon icon-xs me-2" fill="currentColor"
								...
								<path fill-rule="evenodd"
									...
									clip-rule="evenodd"></path></svg> Quay lại trang trước
						</a>
					</div>
					<div
						class="col-12 col-lg-7 order-1 order-lg-2 text-center d-flex align-items-center justify-content-center">
						<img class="img-fluid w-75"
							src="<c:url value='/resources/admin/assets/img/illustrations/500.svg' />"
