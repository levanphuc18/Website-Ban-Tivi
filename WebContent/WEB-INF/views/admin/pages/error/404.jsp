					...
					<div
						...
						<div>
							<img class="img-fluid w-75"
								src="<c:url value='/resources/admin/assets/img/illustrations/404.svg' />"
								alt="404 not found">
							<h1 class="mt-5">
								<span class="fw-bolder text-primary">Không</span> tìm thấy
								trang!
							</h1>
							<p class="lead my-4">Oops! Có vẻ như bạn đã truy cập vào một
								liên kết không hợp lệ.</p>
