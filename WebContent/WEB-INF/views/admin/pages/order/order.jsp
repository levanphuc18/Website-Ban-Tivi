...
<body>
	...
	<main class="content">
			...
			<div class="row justify-content-between align-items-center">
				<div class="col-9 col-lg-8 d-md-flex">
					...
					<form action="${requestScope['javax.servlet.forward.request_uri']}"
						...
						<div class="input-group me-2 me-lg-3 fmxw-300">
							<input type="text" class="form-control" placeholder="Tìm kiếm"
								name="search" value="${search }" /> <a class="input-group-text"
					...
					<select id="state-selection"
						class="form-select fmxw-300 d-none d-md-inline"
						aria-label="Message select example 2">
						<option selected value="">Tất cả</option>
						<option value="0" ${state == 0 ? 'selected' : '' }>Mới
							tiếp nhận</option>
						<option value="1" ${state == 1 ? 'selected' : '' }>Xác
							nhận với khách hàng</option>
						<option value="2" ${state == 2 ? 'selected' : '' }>Đang
							xử lý</option>
						<option value="3" ${state == 3 ? 'selected' : '' }>Đã
							hoàn thành</option>
						<option value="-1" ${state == -1 ? 'selected' : '' }>Đơn
							hàng đã hủy</option>
					</select>
				</div>
		...
		<div
			class="card card-body shadow border-0 table-wrapper table-responsive overflow-hidden">
						...
						<tr>
							...
							<td>
								<!--  <a href="#" class="d-flex align-items-center"><img src="images/profile-picture-1.jpg" class="avatar rounded-circle me-3" alt="Avatar">
                                     -->
								<div class="d-block">
									<a href="${applicationScope.ordersPage }/${order.id}"> <span
										class="fw-bold">${order.id}</span></a>
									<!-- <div class="small text-gray">
                                            <span class="__cf_email__" data-cfemail="fd94939b92bd98859c908d9198d39e9290">[email&#160;protected]</span>
                                        </div> -->
								</div> </a>
							</td>
							<td><span class="fw-normal">${order.shipName}</span></td>
							<td><span
								class="fw-normal d-flex align-items-center text-wrap"> <!-- <svg class="icon icon-xxs text-success me-1" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							...
							<td><span class="fw-normal text-wrap"> <fmt:formatDate
										value="${order.orderDate}" pattern="HH:mm:ss" />

							</span></td>

							<td><span class="fw-normal text-wrap"> <span
							...
							<td><span class="fw-normal text-wrap"> <c:choose>
							...
							<td>
								<div class="btn-group">
									...
									<div
										...
										<a class="dropdown-item d-flex align-items-center"
											href="${applicationScope.ordersPage }/${order.id}"> <svg
								...
								</div> <!-- <svg class="icon icon-xs text-danger ms-1" title="Delete" data-bs-toggle="tooltip" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
