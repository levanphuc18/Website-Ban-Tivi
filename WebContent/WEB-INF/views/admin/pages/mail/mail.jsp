...
<script
	src="<c:url value='/resources/admin/vendor/ckeditor/ckeditor.js' />"></script>
</head>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-sm-12">
								<form:form action="${applicationScope.mailPage }/send"
									modelAttribute="mail" method="POST"
                            ...
                            <path stroke-linecap="round"
											...
											<form:input class="form-control ${emailValid }"
												label="${email}" type="email" path="email"
												placeholder="Nhập địa chỉ email nhận" id="email"
									...
									<div class="mb-4">
										...
										<form:input type="text" path="subject"
											...
											class="form-control ${subjectValid }" id="subject" />
										<form:errors path="subject" class="invalid-feedback"></form:errors>
									</div>

									<div class="mb-4">
										<label for="body">Nội dung</label>
										<form:textarea class="form-control ${bodyValid }" rows="6"
									...
									<div class="">
										<button
											...
											type="submit">
											Gửi
											<svg class="icon icon-xs ms-2" fill="none"
