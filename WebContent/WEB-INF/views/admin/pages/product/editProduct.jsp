		...
		<div class="row pt-4">
			<div class="col-12 col-xl-8">
				<div class="card card-body border-0 shadow">
					...
					<form:form
						action="${applicationScope.productPage }/edit/${product.id}"
						...
						<div class="row mb-3">
							<div class="col-md-6">
								<div>
									...
									<form:input class="form-control" id="id" type="text"
										value="${product.id}" path="id" readonly="true" />
								</div>
							</div>
							<div class="col-md-6">
								<div>
						...
						<div class="row mb-3">
							...
							<div class="col-md-6">
								<div>
									...
									<form:input class="form-control" id="unit" path="unit"
										type="text" value="${product.unit}" />
								</div>
							</div>
						</div>
									...
									<div class="input-group">
										<span class="input-group-text"> <svg
												...
												<path stroke-linecap="round" stroke-linejoin="round"
													stroke-width="2"
													d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
										</span>
										<form:input class="form-control" id="price" path="price"
											type="text"
											label="<fmt:formatNumber value='${product.price}' type='number' groupingUsed = 'false' />" />
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div>
									...
									<form:select path="category.id"
										class="form-select ${categoryValid }" id="category"
										aria-describedby="catgoryHelp">
						...
						<div class="mb-3 d-flex overflow-auto pt-4 flex-nowrap"
							id="preview-images">
							<c:forEach items="${product.images}" var="image" varStatus="i">
								<div
									class='position-relative mr-2 me-3 animate__animated animate__fadeIn'
									style='height: 150px; width: 150px; flex: 0 0 auto'>
									<i
										class='bi bi-x-circle-fill position-absolute top-0 start-100 translate-middle text-danger h5'
										onclick='removeFileFromFileList(this)' data-id="${i.index}"></i>
						...
						<div class="row mb-3">
							<label for="formFile" class="form-label">Chọn file hình
								ảnh</label>
							<form:input class="form-control" type="file" id="images"
								path="images" accept="image/*" multiple="multiple" />
							<small class="form-text text-muted">Chỉ nhận file ảnh,
								kích thước tối đa 20MB</small>
						</div>
							...
							<div class="col-md-12">
								...
								<div class="input-group">
									...
									<form:input path="dateAdded"
										label="<fmt:formatDate value='${product.dateAdded}' pattern='dd/MM/yyyy' />"
										class="form-control" id="dateAdded" type="text"
										readonly="true" />
								</div>
							</div>
						</div>
						...
						<div class="mt-4">
							<button
								class="btn btn-gray-800 mt-2 animate-up-2 d-inline-flex align-items-center"
								type="submit">
					...
					<div class="col-12 mb-4">
						<div class="card shadow border-0 text-center p-0">
							<div class="rounded-top">
								<img
									src="${product.images.size() != 0 ? product.images[0].image : '' }"
									class="img-fluid" style="height: 100%;" alt="${product.name}"
									id="hero-image" />
							</div>
							<div class="card-body pb-5">
								...
								<h4
									class="text-gray d-flex align-items-center justify-content-center">
									<svg class="icon icon-xs me-2" fill="none"
										stroke="currentColor" viewBox="0 0 24 24"
										xmlns="http://www.w3.org/2000/svg">
										<path stroke-linecap="round" stroke-linejoin="round"
											stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"></path></svg>
									${product.id }
								</h4>
								<p
									class="text-danger d-flex align-items-center justify-content-center mb-0">
								...
								<p
									class="text-info mb-4 d-flex align-items-center justify-content-center">
									<svg class="icon icon-xs me-2" fill="none"
										stroke="currentColor" viewBox="0 0 24 24"
										xmlns="http://www.w3.org/2000/svg">
										<path stroke-linecap="round" stroke-linejoin="round"
								...
								<a
									...
									href="${applicationScope.productPage }/${product.id }"> <svg
