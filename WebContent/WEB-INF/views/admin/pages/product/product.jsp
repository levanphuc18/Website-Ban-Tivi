	...
	<main class="content">
		...
		<div
				...
				<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
					<ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
						...
						<li class="breadcrumb-item active" aria-current="page"><a
							href="${applicationScope.productPage }">${title }</a></li>
					</ol>
				</nav>
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				<a href="${applicationScope.productPage }/add"
					...
					<form action="${applicationScope.productPage }" method="get">
						<div class="input-group me-2 me-lg-3 fmxw-300">
							<input type="text" class="form-control" placeholder="Tìm kiếm"
								...
								href="${applicationScope.productPage}"> <svg
				...
				<div class="col-4 col-md-2 col-xl-1 ps-md-0 text-end">
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-xs dropdown-menu-end pb-0">
							<span class="small ps-3 fw-bold text-dark">Hiển thị</span> <a
								class="dropdown-item d-flex align-items-center fw-bold" href="#">
								10 <svg class="icon icon-xxs ms-auto" fill="currentColor"
									viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
										d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
										clip-rule="evenodd"></path>
                                    </svg>
							</a> <a class="dropdown-item fw-bold" href="#">20</a> <a
