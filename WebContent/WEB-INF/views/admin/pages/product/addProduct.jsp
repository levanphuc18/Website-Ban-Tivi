		...
		<div class="py-4">
         ...
         <path stroke-linecap="round" stroke-linejoin="round"
					...
					<li class="breadcrumb-item active" aria-current="page"><a
						href="${applicationScope.addProductPage }">Thêm sản phẩm</a></li>
				</ol>
			</nav>
		...
		<div class="row">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12 col-sm-12">
								<form:form action="${applicationScope.productPage }/add"
									...
									<div class="row mb-4">
										<div class="col-6">
											...
											<form:input type="productName"
												...
												id="productName" placeholder="Nhập tên sản phẩm" />
											<form:errors path="name" class="invalid-feedback" />
										</div>
										<div class="col-6">
											<label for="quantity">Số lượng</label>
											<form:input value="0" type="quantity"
												class="form-control ${quantityValid }" path="quantity"
									...
									<div class="row mb-4">
										<div class="col-6">
											...
											<form:input type="unit" class="form-control" path="unit"
												id="unit" placeholder="Nhập đơn vị tính" />
										</div>
										<div class="col-6">
											<label for="price">Giá tiền</label>
											<form:input value="0" type="price"
												class="form-control ${priceValid }" path="price" id="price"
												aria-describedby="priceHelp" placeholder="50000" />
									...
									<div class="mb-4">
										...
										<form:textarea class="form-control" placeholder="Nhập mô tả"
											id="textarea" rows="4" path="description"></form:textarea>
									</div>
           ...
           const removeFileFromFileList = (e) => {
            ...
            updatePreviewImage(input.files);
									...
									<div class="">
										<button class="btn btn-primary my-0" type="submit">Thêm
											sản phẩm</button>
									</div>
								</form:form>
							</div>
