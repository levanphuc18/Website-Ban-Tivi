...
<body>
			...
			<nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
					...
					<li class="breadcrumb-item"><a
						href="${applicationScope.productPage }">Sản phẩm</a></li>
							...
							<div class=" col-md-3 col-sm-4 col-12">
								<c:choose>
									<c:when test="${product.images.size() != 0 }">
										<img src="${product.images[0].image }" class="img-fluid"
											style="height: 100%;" alt="${product.name}" />
									</c:when>
									<c:otherwise>
										<img src="" class="img-fluid" alt="${product.name}"
											style="height: 100%;" />
									</c:otherwise>
								</c:choose>
							</div>
							...
							<div
								...
								<div
									...
									<div class="">
										...
										<p class="text-gray-400 mb-2">${!product.description ? "Không có mô tả cho sản phẩm" : product.description}
										</p>
									</div>

									<div class="d-flex mt-1">
										<div>
											<span class="small text-info">Lượt xem:</span> <span
												class="fw-normal"> ${product.views } </span>
										</div>
									</div>

									<div class="d-flex mt-1">
										<div>
											<span class="small text-danger">Yêu thích:</span> <span
												class="fw-normal"> ${product.favoriteProducts.size() }
											</span>
										</div>
									</div>
										...
										<div>
											<span class="small text-gray-500">Ngày thêm:</span> <span
												class="fw-normal"> <fmt:setLocale value="vi_VN"
													...
													value="${product.dateAdded}" pattern="dd/MM/yyyy" />
											</span>
										</div>
									</div>
									...
									<div class=" d-flex mt-1">
										<div>
											<span class="small text-gray-500">Số lượng sản phẩm
												thuộc danh mục:</span> <span class="text-success fw-bolder fs-6"></span>
										</div>
									</div>
								</div>

								<div class="col-md-2 col-12 mt-2 d-flex flex-column">
									<a href="${applicationScope.productPage }/edit/${product.id}"
	...
	<%@include
		file="/WEB-INF/views/admin/pages/product/deleteProductModal.jsp"%>
