				...
				<a href="${applicationScope.addCategoryPage }"
					...
					<svg class="icon icon-xs me-2" fill="none" stroke="currentColor"
						...
						<path stroke-linecap="round" stroke-linejoin="round"
							stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path></svg> Thêm danh
					mục
				</a>
					...
					<form action="${applicationScope.categoryPage }" method="get">
						<div class="input-group me-2 me-lg-3 fmxw-300">
							<input type="text" class="form-control" placeholder="Tìm kiếm"
								...
								href="${applicationScope.categoryPage}"> <svg
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<c:forEach items="${pagedListHolder.pageList}" var="category"
						...
						<tr>
							<td><a
								href="${applicationScope.categoryPage}/${category.id}"
								class="fw-bold"> ${category.id} </a></td>
							<td><span class="fw-normal">${category.name}</span></td>
							<td><img src="${category.image}" width=100 height=100
								...
								<div class="btn-group">
									...
									<div class="dropdown-menu py-0">
										...
										<a class="dropdown-item rounded-top"
											href="${applicationScope.categoryPage}/${category.id}"> <i
