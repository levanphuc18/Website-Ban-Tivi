		...
		<div class="row pt-4">
			<div class="col-12 col-xl-8">
				<div class="card card-body border-0 shadow mb-4">
					...
					<form:form
						action="${applicationScope.categoryPage }/edit/${category.id}"
							...
							<div class="col-md-6 mb-3">
								<div>
									...
									<form:input class="form-control" path="id" type="text"
										value="${category.id }" readonly="true" />
								</div>
							</div>
							<div class="col-md-6 mb-3">
								<div>
									<label for="last_name">Tên danh mục</label>
									<form:input class="form-control ${nameValid }" id="name"
										path="name" type="text" />
							...
							<div class="col-md-12 mb-3">
								...
								<div class="input-group">
									...
									<form:input path="dateAdded"
										label="<fmt:formatDate value='${category.dateAdded}' pattern='dd/MM/yyyy'/>"
						...
						<div class="card shadow border-0 text-center p-0">
							<div class="rounded-top">
								<img src="${category.image}" class="img-fluid"
									alt="${category.name}" id="preview-image">
							</div>
							<div class="card-body pb-5">
								...
								<p
									class="text-gray mb-4 d-flex align-items-center justify-content-center">
								...
								<a
									...
									href="${applicationScope.categoryPage }/${category.id }"> <svg
									...
									<div class="d-flex justify-content-xl-center ms-xl-3">
										<div class="d-flex">
											<svg xmlns="http://www.w3.org/2000/svg" width="32"
												...
												class="bi bi-paperclip icon text-gray-500 me-2"
												viewBox="0 0 16 16">
												  <path
											...
											<div class="d-md-block text-left">
												...
												<div class="text-gray small">JPG, GIF hoặc PNG. Kích
