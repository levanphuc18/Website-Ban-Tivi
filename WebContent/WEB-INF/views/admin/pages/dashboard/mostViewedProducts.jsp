	...
	<main class="content">
		...
		<div class="card border-0 shadow">
			<div
				...
				<div
					class=" h2 fs-5 fw-bold mb-0 text-info d-flex align-items-center">
			...
			<div class="card-body">
				<div class="list-group list-group-flush list my--3">
					<c:forEach items="${pagedListHolder.pageList}" var="product"
						varStatus="i">
						<a
							class="list-group-item list-group-item-action px-2 ${i.index != pagedListHolder.getPageSize() ? 'border-bottom' : '' }"
							aria-current="true"
							...
							<div class="row align-items-center justify-content-between">
								...
								<div class="col-auto">
									<div class="d-flex align-items-center">
										...
										<svg class="icon icon-xxs me-2 text-info" fill="none"
