...
<div class="card border-0 shadow">
	<div class="card-header">
		<div class="row align-items-center">
			<div
				class="h2 col d-flex align-items-center text-tertiary fw-bold mb-0 fs-5">
		...
		<div class="list-group list-group-flush">
			...
			<c:forEach items="${applicationScope.lastestOrders}" var="order"
				...
				<a href="${applicationScope.ordersPage}/${order.id}"
					class="list-group-item list-group-item-action ${i.index != i.end ? 'border-bottom' : '' }">
					<div class="row align-items-center">
						<div class="col-auto d-flex flex-column">
							<small class="text-danger"> <fmt:setLocale value="vi_VN"
									scope="session" /> <fmt:formatDate value="${order.orderDate}"
									pattern="HH:mm" />
							</small> <small class="text-danger"> <fmt:setLocale value="vi_VN"
									scope="session" /> <fmt:formatDate value="${order.orderDate}"
									pattern="dd/MM" />
							</small>
							<!-- Avatar -->
	...
	<div class="card-footer border-top bg-gray-50">
		<a class="fw-bold d-flex align-items-center justify-content-center"
