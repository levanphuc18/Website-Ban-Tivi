...
<div class="card border-0 shadow">
	...
	<div class="card-body">
		<div class="list-group list-group-flush list my--3">
			<c:forEach items="${mostViewedProducts}" var="product" varStatus="i"
				begin="0" end="4">
				<a
					...
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-auto">
							...
							<div class="d-flex align-items-center">
								...
								<svg class="icon icon-xxs text-info me-1" fill="none"
	...
	<div class="card-footer border-top bg-gray-50">
		<a class="fw-bold d-flex align-items-center justify-content-center"
			href="${applicationScope.dashboardPage}/${applicationScope.mostViewedProductsPage}">
