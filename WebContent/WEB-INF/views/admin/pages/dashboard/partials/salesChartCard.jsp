...
<div class="card bg-yellow-100 border-0 shadow">
	<div class="card-header d-sm-flex flex-row align-items-center flex-0">
		<div class="d-block mb-3 mb-sm-0">
			...
			<div class="small mt-2">
				<span class="fw-normal me-2">So với hôm qua</span> <span
					...
					class="text-primary fw-bold"> <c:set var="percentageGrowth"
						value="${growthRateOfOrdersComparedToYesterday}"></c:set> <c:if
						test="${percentageGrowth > 0}">
                    	...
                    	</c:if> <c:if test="${percentageGrowth < 0}">
		...
		<div class="d-flex ms-auto">
			...
			<span class="btn btn-secondary text-dark btn-sm me-2"
				id="btn-revenue-by-month">Tháng</span>
		</div>
	</div>
