...
<div class="card border-0 shadow">
	<div
		...
		<div
			class=" h2 fs-5 fw-bold mb-0 text-danger d-flex align-items-center">
	...
	<div class="card-body">
		<div class="list-group list-group-flush list my--3">
			<c:forEach items="${topFavoriteProducts}" var="product" varStatus="i"
				begin="0" end="4">
				<a
					class="list-group-item list-group-item-action px-2 ${i.index != i.end ? 'border-bottom' : '' }"
					aria-current="true"
					href="${applicationScope.productPage }/${product.id}">
					<div class="row align-items-center justify-content-between">
						<div class="col-auto">
							<h3
								class="my-0 ${i.count == 1 ? 'text-danger' : i.count == 2 ? 'text-secondary' : i.count == 3 ? 'text-tertiary' : 'text-gray-400' }">${i.count }</h3>
						</div>
						<div class="col-auto">
							<img class="rounded" width="50" height="50"
								alt="Image placeholder" src="${product.images.get(0).image}" />
						</div>
						<div class="col-5 text-truncate">
							<h4 class="h6 mb-0 text-truncate">${product.name }</h4>
						</div>
						<div class="col-auto">
							<div class="d-flex align-items-center">
								<!-- <div class="bg-success dot rounded-circle me-1"></div> -->
								<svg class="icon icon-xxs text-danger me-1" fill="currentColor"
	...
	<div class="card-footer border-top bg-gray-50">
		<a class="fw-bold d-flex align-items-center justify-content-center"
			href="${applicationScope.dashboardPage}/${applicationScope.topFavoriteProductsPage}">
