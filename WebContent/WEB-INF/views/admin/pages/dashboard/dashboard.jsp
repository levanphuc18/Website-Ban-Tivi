...
<body>
	...
	<main class="content">
		...
		<div class="py-4 d-flex">
			<%@include
				file="/WEB-INF/views/admin/pages/dashboard/partials/shortcuts.jsp"%>
		</div>
		<div class="row">
			<div class="col-12 mb-4">
				<%@include
					file="/WEB-INF/views/admin/pages/dashboard/partials/salesChartCard.jsp"%>
			</div>
			<div class="col-12 col-sm-6 col-xl-4 mb-4">
				<%@include
					file="/WEB-INF/views/admin/pages/dashboard/partials/totalCustomerCard.jsp"%>
			</div>
			<div class="col-12 col-sm-6 col-xl-4 mb-4">
				<%@include
					file="/WEB-INF/views/admin/pages/dashboard/partials/totalRevenueCard.jsp"%>
			</div>
			<div class="col-12 col-sm-6 col-xl-4 mb-4">
				<%@include
					file="/WEB-INF/views/admin/pages/dashboard/partials/invoiceCard.jsp"%>
			</div>
		</div>
		<div class="row">
			<div class="col-12 col-xl-8">
				<div class="row">
					<div class="col-12 mb-4">
						<%@include
							file="/WEB-INF/views/admin/pages/dashboard/partials/topRevenueProductsCard.jsp"%>
					</div>
					<div class="col-12 col-xxl-6 mb-4">
						<%@include
							file="/WEB-INF/views/admin/pages/dashboard/partials/mostViewedProductsCard.jsp"%>
					</div>
					<div class="col-12 col-xxl-6 mb-4">
						<%@include
							file="/WEB-INF/views/admin/pages/dashboard/partials/topFavortiteProductsCard.jsp"%>
					</div>
					<div class="col-12">
						<%@include
							file="/WEB-INF/views/admin/pages/dashboard/partials/lastestOrdersCard.jsp"%>
					</div>
				</div>
			</div>
			<div class="col-12 col-xl-4">
				<div class="col-12 px-0 mb-4">
					<%@include
						file="/WEB-INF/views/admin/pages/dashboard/partials/ordersChartCard.jsp"%>
				</div>
				<div class="col-12 px-0 mb-4">
					<%@include
						file="/WEB-INF/views/admin/pages/dashboard/partials/totalCategoryCard.jsp"%>
				</div>
				<div class="col-12 px-0 mb-4">
					<%@include
						file="/WEB-INF/views/admin/pages/dashboard/partials/productsOfEachCategoryCard.jsp"%>
